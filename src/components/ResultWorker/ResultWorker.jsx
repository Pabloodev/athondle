            ...
            {workerChoosed.map((worker) => {
              ...
              return (
                <li className="resultList" key={worker.id}>
                  ...
                  <span
                    className={result.sexo ? "correct box" : "incorrect box"}
                  >
                    {worker.sexo}
                  </span>
                  <span
                    className={result.setor ? "correct box" : "incorrect box"}
                  >
                    {worker.setor}
                  </span>
                  <span
                    className={result.idade ? "correct box" : "incorrect box"}
                  >
                    {worker.idade}
                  </span>
                  <span
                    className={result.cargo ? "correct box" : "incorrect box"}
                  >
                    {worker.cargo}
                  </span>
                </li>
